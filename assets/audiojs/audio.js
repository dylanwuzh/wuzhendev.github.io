(function(h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            createPlayer: {
                markup: '          <div class="play-pause">             <p class="play"></p>             <p class="pause"></p>             <p class="loading"></p>             <p class="error"></p>           </div>           <div class="scrubber">             <div class="progress"></div>       <div class="progressThumb"></div>         <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
                playPauseClass: "play-pause",
                scrubberClass: "scrubber",
                progressClass: "progress",
                progressThumbClass: "progressThumb",
                loaderClass: "loaded",
                timeClass: "time",
            ...
            updatePlayhead: function(b) {
                ...
                j(a.progressClass, this.wrapper).style.left = c.offsetWidth * b + "px";
